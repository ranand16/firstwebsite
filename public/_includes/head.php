...
<head>
	...
	<link rel="stylesheet" href="css/manual/grids.css">
	<link rel="stylesheet" href="css/manual/common.css">
	<link rel="stylesheet" href="fonts/untitled-font-1/styles.css">
...
<div class="video-container">
		<div class="filter">
			<div class="c1 col-md-8 col-sm-12">
				...
				<div class="qut">
					 <cite title="Source Title">Programmer.Innovator.Joker.</cite>
				</div>
				<br>
				<div class="row">
					<div class="col-md-2">
						<img class="" src="pic2.jpg" alt="picture" width="300" height="250"/>
					</div>
					<div class="col-md-10">
						<blockquote class="blockquote-reverse">
							<p>Recognizition is 20 to Money.</p>
							<footer>Rishabh Anand</footer>
						</blockquote>
					</div>
				</div>
			</div>
